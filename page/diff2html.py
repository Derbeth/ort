...
<table>
    <tr>
        <td class="modified">Zmienione linie:&nbsp;</td>
        <td class="modified">%s</td>
    </tr>
    <tr>
        <td class="added">Dodane linie:&nbsp;</td>
        <td class="added">%s</td>
    </tr>
    <tr>
        <td class="removed">Usunięte linie:&nbsp;</td>
...
<table>
    <tr>
        <th>&nbsp;</th>
        <th width="45%%"><strong><big>Przed</big></strong></th>
        <th>&nbsp;</th>
        <th>&nbsp;</th>
        <th width="45%%"><strong><big>Po</big></strong></th>
    </tr>
    <tr>
        <td width="16">&nbsp;</td>
        <td>
